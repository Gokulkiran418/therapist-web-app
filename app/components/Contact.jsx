...
export default function Contact() {
  ...
  // You can remove this alert if you prefer only the on-page message
    ...
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8">
      ...
      >
        ...
        <p className="text-xs text-center text-[#2C4D4A]">
          Fill out the fields below and Dr. Norman will respond within one business day.
        </p>
        ...
        {/* Message */}
        <div>
          <label className="block font-medium mb-1 text-[#2C4D4A]">Message</label>
          <textarea
            name="message"
