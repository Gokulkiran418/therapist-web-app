...
export default function Hero() {
  ...
  const messages = ["Anxiety Relief", "Relationship Support", "Trauma Recovery"];
      ...
      >
        <div className="relative z-10 px-4 mt-16 max-w-2xl">
          ...
          <div className="mt-6 flex justify-center">
            <a
              href="#contact"
              className="px-6 py-3 text-blue-800 rounded-lg bg-gradient-to-r from-white via-blue-50 to-pink-100 hover:from-blue-50 hover:via-pink-100 hover:to-white transition flex items-center"
            >
